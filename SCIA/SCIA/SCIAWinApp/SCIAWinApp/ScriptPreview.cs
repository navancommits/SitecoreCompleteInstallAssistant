...
namespace SCIA
{
    public partial class ScriptPreview : Form
    {
        ...
        public ScriptPreview(SiteDetails siteDetails)
        {
            ...
            this.Width = 775;
            this.Height = 900;
            WritePreviewFile(sitedetails.SiteName + "_Install_Script_Preview.ps1", sitedetails.HabitatExists, false);
            string text = System.IO.File.ReadAllText(@".\" + sitedetails.SiteName + "_Install_Script_Preview.ps1");
        ...
        {
            WritePreviewFile(sitedetails.SiteName + "_UnInstall_Script_Preview.ps1", sitedetails.HabitatExists, true);
            string text = System.IO.File.ReadAllText(@".\" + sitedetails.SiteName + "_UnInstall_Script_Preview.ps1");
            SetStatusMessage("Happy Sitecoring!", Color.DarkGreen);
            lblPreview.Text = text;
        }
        ...
        {
            DeleteScript(sitedetails.SiteName + "_Delete_Script_Preview.ps1");
            string text = System.IO.File.ReadAllText(@".\" + sitedetails.SiteName + "_Delete_Script_Preview.ps1");
            SetStatusMessage("Happy Sitecoring!", Color.DarkGreen);
            lblPreview.Text = text;
        }
    }
