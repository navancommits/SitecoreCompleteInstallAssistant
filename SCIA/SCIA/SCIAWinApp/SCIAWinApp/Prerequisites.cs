...
namespace SCIA
{
    public partial class Prerequisites : Form
    {
        ...
        void WriteWorkerFile(string path)
        {
            ...
            file.WriteLine("\"" + prereqs.Where(p => p.PrerequisiteKey == redisMsiKey).ToList().FirstOrDefault().PrerequisiteName + ".zip\" = \""+ prereqs.Where(p => p.PrerequisiteKey == commerceZipKey).ToList().FirstOrDefault().PrerequisiteUrl + "\"");
        ...
        void WriteMainFile(string path)
        {
            ...
            file.WriteLine("Invoke-WebRequest -Uri \"" + prereqs.Where(p => p.PrerequisiteKey == msBuildZipKey).ToList().FirstOrDefault().PrerequisiteUrl + "\" -OutFile \".\\" + prereqs.Where(p => p.PrerequisiteKey == commerceZipKey).ToList().FirstOrDefault().PrerequisiteName + "\\" + prereqs.Where(p => p.PrerequisiteKey == msBuildZipKey).ToList().FirstOrDefault().PrerequisiteName + "\"");
            ...
            file.WriteLine(
                "Expand-Archive -Force -LiteralPath " + prereqs.Where(p => p.PrerequisiteKey == commerceZipKey).ToList().FirstOrDefault().PrerequisiteName + "\\" + prereqs.Where(p => p.PrerequisiteKey == msBuildZipKey).ToList().FirstOrDefault().PrerequisiteName + " -DestinationPath '.\\" + prereqs.Where(p => p.PrerequisiteKey == commerceZipKey).ToList().FirstOrDefault().PrerequisiteName + "\\" + msBuildZipKey  + "'");
            file.WriteLine(
